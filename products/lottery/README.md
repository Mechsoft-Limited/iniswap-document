...
* Lottery ticket cost for 1 ticket: ~$5 USD in INI.
...
‌For example, if you have the only ticket that matched three numbers in order, and the predetermined share of the prize pool for your bracket was 2000 INI, you'll receive the full 2000 INI.

‌If, however, you and three other people match three numbers in order, the 2000 INI would be split between the four winning tickets, meaning you would receive 500 INI.
