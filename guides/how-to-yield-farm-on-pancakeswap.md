...
1. **Go to the farm page** [**here**](https://iniswap.finance/farms)**.**
...
**3. Pick which farm you want to use. For this example, we will pick the INI-BNB farm.**
...
**4. Go to the exchange page** [**here**](https://exchange.iniswap.finance/?_gl=1*rbtvb8*_ga*MTUzNDEzNDQxMy4xNjAwNzkzNDM4*_ga_334KNG3DMQ*MTYwNDA2MDUwMS40OC4xLjE2MDQwNjU0NTIuMA..#/swap) **and click “Pool” and then “Add Liquidity”.**
...
**5. Select the tokens to add, in this case BNB and INI. You need to provide them in a 50/50 ratio vs USD value.**

**For example, you would need to add $10 of BNB and $10 of INI. Once you are done, click “Supply”.**
...
**7. You now have liquidity tokens. Next, go back to the farm page** [**here**](https://iniswap.finance/farms)**.**
...
**11. Done! Now you are farming INI tokens!**
